...
Card customCard(Country currCountry, {Color disColor = Colors.black, double distance = 0, Widget arrow = const SizedBox(), String direction = ""}) {
  return Card(
    ...
    child: ListTile(
      ...
      trailing: Container(
        ...
        child: distance == 0 ? Text("") : Text(distance.round().toString() + " km"),
      ),
    ),
  );
}
